        ...
        >
          {steps.map((step, index) => (
            <motion.div key={index} className="relative flex flex-col items-center text-center" variants={itemVariants}>
              <div className="relative z-10 bg-white rounded-xl px-6 py-10 shadow-md hover:shadow-lg transition-shadow w-full h-full">
              ...
              {index < steps.length - 1 && (
                <motion.div 
                  className="hidden md:block absolute top-1/2 right-0 transform translate-x-1/2 h-1 bg-indigo-200 w-10 origin-left"
                  variants={connectingLineVariants}
                  aria-hidden="true"
                />
              )}
              ...
              {index < steps.length - 1 && (
                <motion.div 
                  className="md:hidden h-10 w-1 bg-indigo-200 mt-4"
                  variants={connectingLineVariants}
                  aria-hidden="true"
                />
              )}
